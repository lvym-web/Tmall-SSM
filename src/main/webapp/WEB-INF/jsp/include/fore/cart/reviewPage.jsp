...
<c:forEach items="${o}" var="o">
	<div class="reviewProductInfoDiv">
		<div class="reviewProductInfoImg"><img width="400px" height="400px" src="img/productSingle/${o.orderitems[0].product.productimage[0].id}.jpg"></div>
		<div class="reviewProductInfoRightDiv">
			...
			<table class="reviewProductInfoTable">
				<tr>
					<td width="75px">价格:</td>
					<td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${o.orderitems[0].product.originalprice}" minFractionDigits="2"/></span> 元 </td>
				</tr>
				<tr>
					<td>配送</td>
					<td>快递:  0.00</td>
