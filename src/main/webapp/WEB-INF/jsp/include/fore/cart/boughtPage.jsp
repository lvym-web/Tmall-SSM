...
<div class="boughtDiv">
	<div class="orderType">
		...
		<div><a  orderStatus="waitPay" href="waits?status=待付款">待付款</a></div>
		<div><a  orderStatus="waitDelivery" href="waits?status=待发货">待发货</a></div>
		<div><a  orderStatus="waitConfirm" href="waits?status=待收货">待收货</a></div>
		<div><a  orderStatus="waitReview" href="waits?status=待评价" class="noRightborder">待评价</a></div>
			...
			<table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
				<tr class="orderListItemFirstTR">
					...
					<td class="orderItemDeleteTD">
						<a class="deleteOrderLink" oid="${o.id}" href="deleteOrderHide?oid=${o.id}">
				...
				<c:forEach items="${o.orderitems}" var="oi" varStatus="st">
					<tr class="orderItemProductInfoPartTR" >
						<td class="orderItemProductInfoPartTD"><img width="80" height="80" src="img/productSingle_middle/${oi.product.productimage[0].id}.jpg"></td>
						...
						<c:if test="${st.count==1}">
							...
							<td valign="top" rowspan="${fn:length(o.orderitems)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
								...
								<c:if test="${o.status=='待付款' }">
									<a href="forealipay?oid=${o.id}&total=${oi.product.promoteprice*oi.number}">
