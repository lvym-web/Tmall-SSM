...
<div class="workingArea">
		...
		<table class="table table-striped table-bordered table-hover1  table-condensed">
			...
			<c:forEach items="${pageInfo.list}" var="o">
				<tr>
					<td>${o.id}</td>
					<td>${o.status}</td>
					<td>￥<fmt:formatNumber type="number" value="${o.orderitems[0].number*o.orderitems[0].product.promoteprice}" minFractionDigits="2"/></td>
					<td align="center">${o.orderitems[0].number}</td>
					<td align="center">${o.receiver}</td>
					...
					<td>
						...
						<c:if test="${o.status=='待发货'}">
							<a href="admin_order_delivery?id=${o.id}&pn=${pageInfo.pageNum }">
						...
						<div  class="orderPageOrderItem">
							<table width="800px" align="center" class="orderPageOrderItemTable">
								<c:forEach items="${o.orderitems}" var="oi">
									<tr>
										<td align="left">
											<img width="40px" height="40px" src="img/productSingle/${oi.product.productimage[0].id}.jpg">
										</td>
	...
	<div class="pageDiv">
		<%@include file="../include/admin/listOrderPage.jsp" %>
	</div>
